-- Script decrypted by channel: https://FH2ONTOP
-- Script decrypted by channel: https://FH2ONTOP
-- Script decrypted by channel: https://FH2ONTOP
-- Script decrypted by channel: https://FH2ONTOP
-- Script decrypted by channel: https://FH2ONTOP
...
-- =====================================================
--  ZeyHubb.vs | ANTI DROP (Compact Edition) + FONDOS + WIN DETECT
...
local ConfigFile = "ZeyHubbVs_AntiDrop_Config.json"
local Config = {
...
local function createBillboard(char)
    ...
    billboardGui.Name = "ZeyHubbVsAntiDropBillboard"
...
for _, name in pairs({"ZeyHubbVsUI", "AntiDieUI", "VioletteTPBat"}) do
    local old = game:GetService("CoreGui"):FindFirstChild(name)
    if old then old:Destroy() end
end

local gui = Instance.new("ScreenGui")
gui.Name = "ZeyHubbVsUI"
...
titleLbl.Text = "ZeyHubb.vs | ANTI DROP"
...
do
    local HttpService = game:GetService("HttpService")
    local BG_CONFIG_FILE = "ZeyHubbVs_AntiDrop_BGs.json"
    ...
    pickerGui.Name = "ZeyHubbVsBgPicker"
...
print("ZeyHubb.vs | ANTI DROP (Compact Edition) - Cartel activado por Anti Drop + Fondos + Win Detect")